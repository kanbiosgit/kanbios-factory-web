...
import { Search, Palette, Code, Rocket, Shield, TrendingUp } from 'lucide-react'
            ...
            <Container size="lg" className="relative z-10">
                ...
                >
                    ...
                    <Text size="lg" color="slate-600">
                        12 semaines pour transformer votre idée en produit fonctionnel.
                    </Text>
                </motion.div>
                ...
                <div className="hidden lg:block relative max-w-6xl mx-auto">
                    <div className="relative">
                        ...
                        <motion.div
                            className="absolute top-[68px] w-2 h-2 rounded-full shadow-glow-cyan"
                            style={{
                                ...
                                >
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="relative mb-4">
                                            <IconWrapper variant="default" size="lg" className="hover-glow">
                                    ...
                                    <div className="text-center mt-6">
                                        <Text size="xs" color="slate-600" className="mb-2">
                                            {step.duration}
                                        </Text>

                                        <Heading level="h4" color="dark" align="center" className="mb-3">
                                            {step.title}
                                        </Heading>

                                        <Text size="sm" color="slate-600" className="mb-3 line-clamp-2">
                                            {step.description}
                                        </Text>
                                ...
                                <Card variant="default" hover>
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <Text size="sm" color="slate-600" className="mb-2">
                                                {step.description}
                                            </Text>
                                            <Text size="xs" weight="semibold" color="blue">
                                                {step.keyPoint}
