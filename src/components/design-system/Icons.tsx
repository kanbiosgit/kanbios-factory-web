...
export function Icon({ size = 'md', color = 'default', className, children, ...props }: IconProps) {
    const sizes = {
        sm: 'h-4 w-4',
        md: 'h-5 w-5',
        lg: 'h-6 w-6',
...
export function CheckIcon({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
    return (
...
export function ErrorIcon({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
    return (
...
export function WarningIcon({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
    return (
...
export function InfoIcon({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
    return (
...
export function IconWrapper({
    ...
    const variants = {
        ...
        primary: 'bg-gradient-to-br from-blue-500/10 to-cyan-400/10 border border-blue-500/20 text-blue-500',
