...
const buttonVariants = cva(
    "inline-flex items-center justify-center font-semibold rounded-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-offset-2",
    {
        variants: {
            variant: {
                primary:
                    "bg-gradient-to-r from-blue-500 to-cyan-400 hover:from-blue-400 hover:to-cyan-300 text-white shadow-lg shadow-blue-500/25 focus:ring-blue-400",
                secondary:
                    "bg-white hover:bg-slate-50 text-blue-600 border-2 border-blue-500 focus:ring-blue-400",
                outline:
                    "border-2 border-slate-700 text-slate-700 hover:bg-slate-50 focus:ring-slate-400",
...
export function Link({
    ...
    const variants = {
        ...
        gradient:
            "bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent hover:from-blue-400 hover:to-cyan-300",
    };
    ...
    return (
        <NextLink
            ...
            {showArrow && (
                <ArrowRight
                    className="me-2 h-4 w-4 inline transition-transform group-hover:translate-x-1"
                    aria-hidden="true"
                />
            )}
            {children}
